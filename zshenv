...
# MYSQL stuffs
MYSQL_PATH="/usr/local/mysql-8.4.1-macos14-arm64/"
export MYSQL_CLIENT="$MYSQL_PATH/bin"
export PKG_CONFIG_PATH="$MYSQL_PATH/lib/pkgconfig"
export MYSQL_HOME="$MYSQL_PATH/include"
export MYSQLCLIENT_LDFLAGS="-L$MYSQL_PATH/lib"
export LDFLAGS="-L$MYSQL_PATH/lib"
export MYSQLCLIENT_CFLAGS="-I$MYSQL_PATH/include"
